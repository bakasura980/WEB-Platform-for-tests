<?php
	...
	$select1 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'A' AND klas = '10'";
	...
	$select2 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0 AND paralelka = 'A' AND klas = '10' " .
	...
	echo "</table>\n";
	}elseif(isset($_POST['10_B']))
	{
	
		$select17 = "SELECT test_id " .
				"FROM questions " .
				"WHERE predmet = 'Istoriq' AND paralelka = 'B' AND klas = '10'";
		...
		$select3 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id = $test_id1 AND predmet = 'Istoriq' AND paralelka = 'B' AND klas = '10'";
		...
		$select4 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id = $test_id1 AND student_id != 0 AND paralelka = 'B' AND klas = '10' " .
			"ORDER BY user_id ASC";
		...
		echo "</table>\n";
	}elseif(isset($_POST['10_V']))
	{
		$select5 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'V' AND klas = '10'";
		...
		$select6 = "SELECT user_id,name,ocenka FROM student " .
				"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0  AND paralelka = 'V' AND klas = '10'" .
				"ORDER BY user_id ASC";
		...
		echo "</table>\n";
	}elseif(isset($_POST['10_G']))
	{
		$select7 = "SELECT nameoftest " .
					"FROM questions " .
					"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'G' AND klas = '10' AND klas = '10'";
		...
		$select8 = "SELECT user_id,name,ocenka FROM student " .
				"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0  AND paralelka = 'G' AND klas = '10'" .
				"ORDER BY user_id ASC";
