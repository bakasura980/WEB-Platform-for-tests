<?php
	...
	$select1 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'A' AND klas = '11' ";
	...
	$select2 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0 AND paralelka = 'A' AND klas = '11'" .
	...
	$select3 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'B' AND klas = '11' ";
	...
	$select4 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0 AND paralelka = 'B' AND klas = '11'" .
			"ORDER BY user_id ASC";
	...
	$select5 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'V' AND klas = '11' ";
	...
	$select6 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0  AND paralelka = 'V' AND klas = '11'" .
			"ORDER BY user_id ASC";
	...
	$select7 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id=(SELECT max(test_id) FROM questions) AND predmet = 'Istoriq' AND paralelka = 'G' AND klas = '11' ";
	...
	$select8 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Istoriq' AND test_id=(SELECT max(test_id) FROM student) AND student_id != 0  AND paralelka = 'G' AND klas = '11'" .
			"ORDER BY user_id ASC";
