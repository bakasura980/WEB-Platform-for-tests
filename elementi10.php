<?php
	...
	$select17 = "SELECT test_id " .
				"FROM questions " .
				"WHERE predmet = 'Elementi' AND paralelka = 'A' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select11 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id = $test_id1  AND predmet = 'Elementi' AND paralelka = 'A' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select12 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Elementi' AND test_id = $test_id1 AND student_id != 0 AND paralelka = 'A' AND klas = '10' AND teacher_name = '$teacher_name1' " .
	...
	$select17 = "SELECT test_id " .
				"FROM questions " .
				"WHERE predmet = 'Elementi' AND paralelka = 'B' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select13 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id = $test_id1  AND predmet = 'Elementi' AND paralelka = 'B' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select14 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Elementi' AND test_id = $test_id1 AND student_id != 0 AND paralelka = 'B' AND klas = '10' AND teacher_name = '$teacher_name1' " .
			"ORDER BY user_id ASC";
	...
	$select17 = "SELECT test_id " .
				"FROM questions " .
				"WHERE predmet = 'Elementi' AND paralelka = 'V' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select5 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id = $test_id1  AND predmet = 'Elementi' AND paralelka = 'V' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select6 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Elementi' AND test_id=$test_id1 AND student_id != 0  AND paralelka = 'V' AND klas = '10' AND teacher_name = '$teacher_name1' " .
			"ORDER BY user_id ASC";
	...
	$select17 = "SELECT test_id " .
				"FROM questions " .
				"WHERE predmet = 'Elementi' AND paralelka = 'G' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select5 = "SELECT nameoftest " .
				"FROM questions " .
				"WHERE test_id = $test_id1  AND predmet = 'Elementi' AND paralelka = 'G' AND klas = '10' AND prepodavatel = '$teacher_name1'";
	...
	$select6 = "SELECT user_id,name,ocenka FROM student " .
			"WHERE predmet = 'Elementi' AND test_id=$test_id1 AND student_id != 0  AND paralelka = 'G' AND klas = '10' AND teacher_name = '$teacher_name1' " .
			"ORDER BY user_id ASC";
